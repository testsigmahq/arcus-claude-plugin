...
Environment (all optional — auth/host now come from /arcus:login config.json):
  CLAUDE_CONFIG_DIR    — Claude home (default: ~/.claude); data goes under {claude_home}/plugins/data/arcus
